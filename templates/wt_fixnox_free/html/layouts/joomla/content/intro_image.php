...
<?php if($intro_image) : ?>
	...
	<?php if ($params->get('link_titles') && $params->get('access-view')) : ?>
		...
		<?php endif; ?>
	<?php endif; ?>		
		<img<?php if ($params->get('link_titles') && $params->get('access-view') && $image_transition) : ?><?php echo ' class="el-image'. $image_transition .'"'; ?><?php endif; ?> src="<?php echo $intro_image; ?>" alt="<?php echo htmlspecialchars($images->image_intro_alt ?? "", ENT_COMPAT, 'UTF-8'); ?>">	
	<?php if ($params->get('link_titles') && $params->get('access-view')) : ?>
		<?php if($image_transition) : ?>
			</div>
		<?php endif; ?>
